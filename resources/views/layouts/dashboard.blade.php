            ...
            <div class="border-right" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a 
                        ...
                        class="list-group-item list-group-item-action {{ (request()->is('dashboard/lokasi*')) ? 'active' : '' }}"
            ...
            <div id="page-content-wrapper">
                <nav class ="navbar navbar-expand-lg navbar-light navbar-store fixed-top" data-aos="fade-down" data-target="#navbarResponsive" data-aos-easing="linear" data-aos-duration="800">
                    <div class="container-fluid">
                        <button class="btn btn-info d-md-none mr-auto mr-2" id="menu-toggle">
                            &laquo; <strong>MENU</strong>
                        </button>       
                            ...
                            <ul class="navbar-nav d-none d-lg-flex ml-auto">
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="{{ route('home') }}" class="dropdown-item">Beranda Utama</a>
