            ...
            <div class="container">
                        ...
                        <table class="table table-borderless table-cart" aria-describedby="Cart">
                            ...
                            <tbody>
                                ...
                                {{-- <tr>
                                    <td style="width: 25%;">
                                        <img 
                                            src="/images/product-chart/pic_2.png" 
                                            alt="" 
                                            class="cart-image w-100"
                                        />
                                    </td>
                                    <td style="width: 35%;">
                                        ...
                                        <div class="product-subtitle">by Ramadhanu</div>
                                    </td>
                                    <td style="width: 35%;"> 
                                ...
                                <tr>
                                    <td style="width: 25%;">
                                        <img 
                                            src="/images/product-chart/pic_3.png" 
                                            alt="" 
                                            class="cart-image w-100"
                                        />
                                    </td>
                ...
                >
                    ...
                    <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="zip_code">PostalCode</label>
                                <input type="text" class="form-control" id="zip_code" name="zip_code" value="36455">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="col-4 col-md-3">
                            {{-- <div class="product-title">Rp.280.000</div>
                            <div class="product-subtitle">Product Insurance</div> --}}
                        </div>
                        <div class="col-4 col-md-2">
                            {{-- <div class="product-title">Rp.58.0000</div>
