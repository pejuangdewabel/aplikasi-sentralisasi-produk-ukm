...
Route::get('/pemetaan', 'PemetaanController@index')->name('pemetaan-maps');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/dashboard/lokasi', 'DashboardPemetaanController@index')->name('dashboard-pemetaan');
    Route::post('/dashboard/lokasi-input', 'DashboardPemetaanController@inputMaps')->name('dashboard-pemetaan-input');
